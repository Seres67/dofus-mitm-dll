...
public:
    bool Hook(std::string_view moduleName, std::string_view functionName, HookFncPtr hookAddress) const;
    bool Hook(FncPtr originalAddress, HookFncPtr hookAddress) const;
